    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../website/website/page/home.php" class="navbar-brand" rel="tooltip"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation"
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/user_cart.php" onclick="scrollToDownload()">
                            <i class="now-ui-icons shopping_cart-simple"></i>
                            <p>Shopping Cart</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pschat/chat_login_page.php">
                            <i class=""></i>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true"
                style="background-image: url('./assets/img/landscape.jpeg');">

                <div class="container">
                    <div class="content-center brand">
                        <img src="./assets/img/elogo.png" alt="Circle Image" class="rounded-circle">
                        <br><br>
                        <h3>Don't Waste Just Earn.</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>
                                ...
                                given them anything else to care about.”-Seth Godin, American author, entrepreneur,
                        ...
                        <center>
                            ...
                            <form method="POST" action="index_search.php">
                                ...
                                <input type="text" name="search" class="search-query" placeholder="Search for items">
