                            ...
                            <div class="panel-body">
                                <form action="supplier_update.php" method="post">
                                    <div class="form group">
                                        <input type="hidden" class="form-control" id="supp_id" name="supp_id"
                                            value=<?php echo $_GET['supp_id'];?>>
                                        ...
                                        <input type="text" class="form-control" id="supp_address" name="supp_address"
                                            value="<?php echo $supp_address;?>">
                                        <label for="supp_contact">Contact Details:</label>
                                        <input type="text" class="form-control" id="supp_contact" name="supp_contact"
                                            value="<?php echo $supp_contact;?>">
                                        <label for="supp_email">Email:</label>
                                        <input type="text" class="form-control" id="supp_email" name="supp_email"
                                            value="<?php echo $supp_email;?>">
