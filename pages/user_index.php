    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation"
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="../admin/admin_login_page.php" class="nav-link" onclick="scrollToDownload()">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="user_change_password.php" onclick="scrollToDownload()">
                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                            <p>change password</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../pschat/post_index.php">
                            <i class=""></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../pschat/loader.php">
                            <i class=""></i>
                            <p>Add Post</p>
                        </a>
                    </li>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h6><a class="btn btn-success btn-round" title="Click for more details!"
                                                href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i
