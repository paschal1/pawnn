...
<head>
    <meta charset="utf-8" /=- <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/apple-icon.png">
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <img class="d-block" src="../uploads/<?php echo $res['prod_pic2']; ?>"
                                                    alt="Second slide">
                                                <?php else: ?>
                                                <img src="../uploads/default.png">
                                                <?php endif; ?>
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <img class="d-block" src="../uploads/<?php echo $res['prod_pic3']; ?>"
                                                    alt="Third slide">
                                                <?php else: ?>
                                                <img src="../uploads/default.png">
                                                <?php endif; ?>
