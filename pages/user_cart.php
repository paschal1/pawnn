        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    ...
                    <a class="btn btn-primary btn-round" href="user_index.php"><i
          ...
          ?>
                                            ...
                                            <tr>
                                                <td> <img width="150" height="100"
                                                        src="../uploads/<?php echo $row2['prod_pic1'];?>" alt="" /></td>
                                                ...
                                                <td>
                                                    <a
                                                        href="edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>"><button
                                                            class="btn btn-warning btn-round" type="button">update
                                                            qty</button></a>
                                                    <a
                                                        href="delete_order_details.php?order_id=<?php echo $row['order_details_id'];?>"><button
            ...
            ?>
                                    ...
                                    <button type="submit" id=""
                                        onclick="return confirm('Are you sure you want to Checkout?')" name="submit"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="shipaddress"
                                                            placeholder="Complete Address For Delivery Purpose."
                                                            required />
                                                        <select class="btn btn-warning btn-round dropdown-toggle"
                                                            size="1" name="city">
                                                            <option value="lagos City">lagos</option>
                                                            <option value="Calabar City">Cross River</option>
                                                            <option value="Abakaliki City">Ebonyi</option>
                                                            <option value="Enugu City">Enugu</option>
                                                            <option value="Umahia City">Abia</option>
                                                            <option value="Owerri City">Imo</option>
                                                            <option value="Asaba City">Delta</option>
                                                            <option value="Port Harcourt City">Rivers</option>
                                                            <option value="Uyo City">Akwaibom</option>
                                                            <option value="Bayelsa City">Bayelsa</option>
                                                            <option value="Awka City">Anambra</option>
                                                            <option value="Benue City">Benue</option>
                                                            <option value="FCT City">Abuja</option>
                                                            <option value="Kaduna City">Kaduna</option>
                                                            <option value="Kastina City">Kastina</option>
                                                            <option value="Illorin City">Kwara</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a><button type="submit" name="submit"
                                                            class="btn btn-success btn-round"><i
                                                                class="now-ui-icons shopping_delivery-fast"></i>
                                                            Submit</button></a>
                                                </div>
                                            </div>
                                        </div>
