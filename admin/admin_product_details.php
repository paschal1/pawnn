            ...
            <div class="section section-basic">
                ...
                <div class="section" id="carousel">
                    <div class="container">
                        ...
                        <a class="btn btn-primary btn-round" href="admin_index.php"><i
...
?>
        ...
        if ($prod_qty<=10){
        ?>
                                <b>Items in stock: </b><span style="color:red;"><?php echo $res['prod_qty'];?>
                                    :Reorder!</span>
                                <?php
        }else{
       ?>
    ...
    <footer class="footer" data-background-color="black">
        <div class="container">
            ...
            <div class="copyright">
                ...
                </script>, Designed and Coded by Serve(8) Starite Technology, Inc.
            </div>
        </div>
    </footer>
    </div>
