    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip"
                    title="Designed and Coded by Serve(5) Start Technology, Inc." data-placement="bottom" target="">
                    E-Ps Pawn .ng
                </a>
    ...
    <div class="wrapper">
        <div class="page-header page-header-small" filter-color="orange">
            <div class="page-header-image" data-parallax="true"
                style="background-image: url('../assets/img/Images/images26.jpg');"></div>
            <div class="container">
                <div class="content-center">
                    <div class="photo-container">
                        <img src="../assets/img/Images/dd.jpg" alt="">
                    </div>
                    <h2 class="title">
                        <?php
                            include('../config/dbconn.php');
    ...
    <div class="section">
        <div class="container">
            <div class="button-container">
                ...
                <a href="https://www.twitter.com" target="_blank" class="btn btn-default btn-round btn-lg btn-icon"
                    rel="tooltip" title="Follow me on Twitter">
                    <i class="fa fa-twitter"></i>
                </a>
                <a href="https://www.instagram.com" target="_blank" class="btn btn-default btn-round btn-lg btn-icon"
                    rel="tooltip" title="Follow me on Instagram">
                    <i class="fa fa-instagram"></i>
                </a>
            </div>
            <div class="row">
                    ...
                    <div class="tab-pane active" id="products" role="tabpanel">
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="row collections">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="product_add.php"><i
                                        class="now-ui-icons ui-1_simple-add"></i> Add Product</a>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="supplier" role="tabpanel">
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="row collections">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="supplier_add.php"><i
                                        class="now-ui-icons ui-1_simple-add"></i> Add Supplier</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row collections">
                                ...
                                <table id="" class="table table-bordered table-striped">
                                    ...
                                    <?php
                                            ...
                                            ?>
                                    <tr>
                                        <td><?php echo $row['firstname']." ".$row['lastname']." ".$row['action']." last ".$row['date'];?>
                                        </td>
                                    </tr>
                                    <?php
                                              }
                    ...
                    <div class="tab-pane" id="admin_accounts" role="tabpanel">
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="row collections">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="admin_signup.php"><i
                                        class="now-ui-icons ui-1_simple-add"></i> Add Admin Account</a>
                            </div>
                        </div>
                    </div>
                </div>
