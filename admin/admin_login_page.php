    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation"
                data-nav-image="../assets/img/Images/case1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="admin_login.php">
                        ...
                        <div class="footer text-center">
                            <button type="submit" class="bbtn btn-primary btn-round btn-lg btn-block"
                        ...
                        <div class="pull-right">
                            <h6>
                                <a href="change_password.php" class="link">Forgot Password?</a>
                            </h6>
                        </div>
                    </form>
                    <br><br>
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </a> Designed and Coded by Serve(5) Starite Technology, Inc.
                </div>
            </div>
        </footer>
    </div>
