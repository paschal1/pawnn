        ...
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip"
                    title="Designed and Coded by Serve(5) Starite Technology, Inc." data-placement="bottom">
                    E-Ps Pawn.ng
                </a>
...
?>
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(../assets/img/bg6.jpg)"></div>
        <div class="container">
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="">
                        ...
                        <div class="footer text-center">
                            <button type="submit" class="bbtn btn-primary btn-round btn-lg btn-block" id="submit"
                                name="submit">
                                Create account
