        ...
        <div class="bg">
            ...
            <div class="container">
                ...
                <form method="post" class="navbar-form navbar-right">
                    <div class="form-group" style="position:absolute;left:69.6%; top:5.18%; font-size:13px; "> <input
                            class="form-control" type="text" name="search" style="width:149.5;" id="searchbar"
                ...
                <div style="position:absolute;left:50.6%; top:14.8%;"> <a href="status.php"
                        style="text-decoration:none;"> <input type="button" value="Sales" id="singup_button"> </a>
                </div>
                                ...
                                <div>
                                    ...
                                    <span>&#8358;<?php echo $post_data[3]; ?><span>
                                            ...
                                            <form method="post">
                                                ...
                                                <button type="submit" name="delete_post" value=" "
                                                    style="background-color:#FFFFFF; color:red; border:#FFFFFF;  width:2.4%;">
                                                    Delete</button>
                                            </form>
                                            <a href="chat.php"><button type="button" name="send_chat"
                                                    class="btn btn-default send_chat"
                                                    id="<?php echo $post_data[1];?>">Chat</button></a>
                                            <?php
