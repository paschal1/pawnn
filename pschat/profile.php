...
$gender="";
	if(isset($_POST['txt']))
	{
		...
		mysqli_query($dbconn,"INSERT INTO user_post(user_id,post_txt,price,post_time,priority) VALUES ('$id','$txt','$price','$post_time','$priority');");
	}
...

	{
		...
		if(move_uploaded_file($img_tmp_name,"../uploads/".$user."/Post/".$prod_img_path))
		{
			//move_uploaded_file($img_tmp_name,"../uploads/".$user."/Post/".$prod_img_path);
		}
		else
		{
			//move_uploaded_file($img_tmp_name,"../uploads/".$user."/Post/".$prod_img_path);
		}
    	mysqli_query($dbconn,"INSERT into user_post(user_id,post_txt,price,post_time,priority,post_pic) values('$userid','$txt','$price','$post_time','$priority','$img_name');");
	}
	if(isset($_POST['delete_post']))
	{
		$post_id=intval($_POST['post_id']);
		mysqli_query($dbconn,"DELETE FROM user_post where post_id=$post_id;");
	}
	if(isset($_POST['Like']))
	{
		$post_id=intval($_POST['postid']);
		$user_id=intval($_POST['userid']);
		mysqli_query("INSERT into user_post_status(post_id,user_id,status) values($post_id,$user_id,'Like');");
	}
	if(isset($_POST['Unlike']))
	{
		$post_id=intval($_POST['postid']);
		$user_id=intval($_POST['userid']);
		mysqli_query("delete FROM user_post_status where post_id=$post_id and  	user_id=$user_id;");
	}
	if(isset($_POST['comment']))
	{
		...
		if($txt!="")
		{
		mysqli_query("INSERT into user_post_comment(post_id,user_id,comment) values($post_id,$user_id,'$txt');");
		}
	}
	if(isset($_POST['delete_comment']))
	{
		$comm_id=intval($_POST['comm_id']);
		mysqli_query("delete FROM user_post_comment where comment_id=$comm_id;");
	}
?>
<html>
<head>
...
<?php
	$userid=$_SESSION['id'];
	$que_post_img=mysqli_query($dbconn,"SELECT * FROM user_post where user_id=$userid and post_pic!='' order by post_id desc");
...
<form method="post" name="posting_txt" onSubmit="return blank_post_check();" id="post_txt">
	...
	<input type="text" name="price" class="form-control" style="height:50; width:100;" placeholder="Enter Price"></div>	
...
<?php
	$que_post_bg1=mysqli_query($dbconn,"SELECT * FROM user_post where user_id=$userid");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($dbconn,"SELECT * FROM user_post where user_id=$userid order by post_id desc");
	while($post_data=mysqli_fetch_array($que_post))
	{
		...
		$que_user_info=mysqli_query($dbconn,"SELECT * FROM users where user_id=$post_user_id");
		$que_user_pic=mysqli_query($dbconn,"SELECT * FROM user_profile_pic where user_id=$post_user_id");
...
?>
	<tr>
		...
		<tr>
		<td width="5%" style="padding-left:10;" rowspan="2"> <img src="../../pawn_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
...
<?php 
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../pawn_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Post/<?php echo $post_img; ?>" width="400" height="400"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
	...
	<tr style="color:#6D84C4;">
		<td >   </td>
		<?php
		 	$que_status=mysqli_query($dbconn,"SELECT * FROM user_post_status where post_id=$postid and user_id=$userid;");
			$que_like=mysqli_query($dbconn,"SELECT * FROM user_post_status where post_id=$postid");
		...
		<input type="submit" value="Like" name="Like" style="border:#FFFFFF; background:#FFFFFF; font-size:15px; color:#6D84C4;" onMouseOver="like_underLine(<?php echo $postid; ?>)" onMouseOut="like_NounderLine(<?php echo $postid; ?>)" id="like<?php echo $postid; ?>"></form></td>
		 ...
		 <?php
		 	...
		 	$que_comment=mysqli_query($dbconn,"SELECT * FROM user_post_comment where post_id =$postid order by comment_id");
...
<?php
	while($comment_data=mysqli_fetch_array($que_comment))
	{
		...
		$que_user_info1=mysqli_query("SELECT * FROM users where user_id=$comment_user_id");
		$que_user_pic1=mysqli_query("SELECT * FROM user_profile_pic where user_id=$comment_user_id");
...
?>
	...
	<tr>
		<td> </td>
		<td width="4%" bgcolor="#EDEFF4" style="padding-left:12;" rowspan="2">  <img src="../../pawn_users/<?php echo $user_gender1; ?>/<?php echo $user_Email1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">    </td>
...
<tr>
	<td> </td>
	<td width="4%" style="padding-left:17;" bgcolor="#EDEFF4" rowspan="2">  <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
...
<!-- About bg-->
	...
	<div style="position:absolute;left:22%; top:83%; font-size:15px;"> <?php //echo $res['gender']; ?></div>
...
<?php
	$user_info_query=mysqli_query($dbconn,"SELECT * FROM user_info where user_id=$userid");
...
?>
	<div style="position:absolute; left:15.5%; top:108%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img_array[0] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:108%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[1] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:108%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[2] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:125%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[3] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:125%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[4] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:125%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[5] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:142%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[6] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:142%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[7] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:142%;"> <img src="../../pawn_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[8] ?>" height="90" width="78">  </div>
