...
?>
                        ...
                        $postid="";
                        $query = "SELECT * FROM user_post WHERE post_id='$postid'";
...
<?php
    ...
    $last_id = $_SESSION['post_id'];
    $query = "SELECT * FROM user_post WHERE post_id = $last_id";
    $result = mysqli_query($dbconn,$query);
    while($res = mysqli_fetch_array($result)) { 
...
?>   
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="">
                        ...
                        <?php echo $_SESSION['id'];?>
                            <?php if($res['post_pic'] != ""): ?>
                            <img class="d-block" src="../users/<?php echo $res['post_pic']; ?>" alt="First slide">
                            <?php else: ?>
        ...
        <h4><br><br>
        <ul><b>Serial number: 
        <span style="color:green;"><?php echo $res['price']; ?></span></b>
        </ul>
        <ul><b>Product name: </b> 
