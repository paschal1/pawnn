...
<div style="position:absolute;left:44.7%; top:54%; font-weight:bold; z-index:1; color:#3B59B0;"> <a href="photo.php" style="text-decoration:none; color:#3B59B0;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php //echo $photos_count; ?> </samp> </div>
...
<div style="position:absolute;left:53%; top:175%; font-size:18px; color:#89919C;">Pawn ID </div>
...
<?php
	...
	// {
?>
		<div style="position:absolute;left:61%;top:175%; color:#3B59A4; font-weight:bold;"> Add Pawn ID </div>
<?php
	// }
?> 
