...
<button style="text-align:center; margin-left:30%;" onclick="ifunction()">colors</button>
<button>fonts</button>
<button>Emojis</button><br><br>
</body>
</html>
<script>
...
<?php
                        ...
                        $query = "SELECT * FROM user_status_product WHERE user_id='$post_id' limit 1";
                        $result = mysqli_query($dbconn,$query);
                        while($res = mysqli_fetch_array($result)){

                                    $post_id=$res['product_id'];
                                    $prod_price=$res['product_price'];
                                   // $user_id = $_SESSION['id'];
                                    ...
                                    if (isset($_POST['submit'])){
                                        ...
                                        mysqli_query($dbconn,"INSERT INTO order_details (prod_id,prod_qty,total,user_id) 
                                                VALUES ('$post_id','$prod_qty','$total','$user_id')") or die(mysql_error());
                                            ?>
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <?php if($res['post_pic'] != ""): ?>
                                                <img class="d-block" src="../uploads/<?php echo $res['post_pic']; ?>"
                                                    alt="First slide">
                                                <?php else: ?>
                                                <img src="../uploads/default.png">
                                                <?php endif; ?>
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5><?php echo $res['post_txt']; ?></h5>
                                                </div>
                                            </div>
                        ...
                        ?>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a><button type="submit" name="submit"
                                                        class="btn btn-success btn-round">Order</button></a>
                                            </div>
                                        </div>
                                    </form>
