...
<head>
    ...
    body {
		...
		triangle, rgba(55, 184,219,1) 0%, rgba(20, 84,219,1) 100%; */
    ...
    <div class="bg">
        ...
        <div class="container">
            ...
            <form method="POST" class="navbar-form navbar-right">
                <div style="position:absolute;left:90.8%;top:4.2%; " class="form-group"> </div>
                <div style="position:absolute;left:69.6%; top:5.18%; font-size:13px; " class="form-group"> <input
                        type="text" name="search" class="form control search-query" placeholder="Search Users"
                        onkeydown="searchq()"></div>
            </form>

            <div style="position:absolute;left:13.6%; top:14.8%;"> <a href="" style="text-decoration:none;"> <input
                        type="button" value="Chats" id="signup_button"> </a> </div>
        ...
        font-family: 'Times New Roman', Times, serif; font-size:20px;">Members</div>
            ...
            <div id="" style="position: relative; left:80.4%; top:30.8%; margin:3px;  color:white; "></div>
